...
def read_six_digit_numbers(filepath, omit=None):
    """
    Reads a text file where each row contains a 6-digit number.
    Returns a list of valid 6-digit numbers as strings,
    excluding any specified in 'omit'.
    
    Parameters:
        filepath (str): path to the .txt file
        omit (iterable of str, optional): 6-digit numbers to exclude
    """
    pattern = re.compile(r'^\d{6}$')
    omit_set = set(omit) if omit is not None else set()
    ...
    with open(filepath, 'r') as f:
        for line in f:
            value = line.strip()
            if pattern.match(value) and value not in omit_set:
                six_digit_numbers.append(value)
...
all_ids = ['135124','140117','144226','145834','146129','146432',
           '146735','172130','173334','175237','176542','177746'
           '178142','178243','178647','180533','191841','192439','192641',
           '195041','197348','198653','199655','397760','401422','406836',
           '412528','429040','680957','690152','706040','724446','732243',
           '751550','757764','765864','770352','771354','905147']
#all_ids９ = ['905147']
...
for ids in range(0,len(all_ids)):
    ...
    try:
        ...
        tf.keras.backend.clear_session() #5/3/26
